    ...
    <div className="relative w-full h-[80vh] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col gap-5 items-center justify-center text-white text-center">
        ...
        <div className="flex gap-5 font-medium py-5">
          <button className="px-7 py-2.5 bg-[var(--color-primary)] rounded-md">
            Sign up
          </button>
        ...
        <div className="bg-[var(--color-primary-content)] py-3 px-5 flex items-center gap-3 text-black w-3xl rounded-md">
